...
{
    public sealed partial class OutlookActiveSyncSettingsPage : Page
    {
        private readonly IWorkbook workbook;
        private readonly ICryptoService cryptoService;
        private readonly OutlookActiveSyncSettingsViewModel viewModel;

        public OutlookActiveSyncSettingsViewModel ViewModel
        {
        ...
        public OutlookActiveSyncSettingsPage()
        {
            ...
            this.viewModel = new OutlookActiveSyncSettingsViewModel(this.workbook, navigationService, messageBoxService, synchronizationManager, trackingManager);
